    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 22, 4, 400);
    			attr_dev(header, "class", "svelte-kw0oem");
    			add_location(header, file$5, 21, 0, 387);
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*mode*/ ctx[3]) + " svelte-13w7qrc"));
    			attr_dev(button, "type", /*type*/ ctx[0]);
    			add_location(button, file$4, 88, 0, 1332);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*mode*/ 8 && button_class_value !== (button_class_value = "" + (null_to_empty(/*mode*/ ctx[3]) + " svelte-13w7qrc"))) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$4, 86, 0, 1295);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 71, 6, 1098);
    			attr_dev(h2, "class", "svelte-nrlo7l");
    			add_location(h2, file$3, 72, 6, 1121);
    			attr_dev(p0, "class", "svelte-nrlo7l");
    			add_location(p0, file$3, 73, 6, 1147);
    			attr_dev(header, "class", "svelte-nrlo7l");
    			add_location(header, file$3, 70, 4, 1083);
    			...
    			add_location(img, file$3, 76, 6, 1208);
    			attr_dev(div0, "class", "image svelte-nrlo7l");
    			add_location(div0, file$3, 75, 4, 1182);
    			attr_dev(p1, "class", "svelte-nrlo7l");
    			add_location(p1, file$3, 79, 6, 1290);
    			attr_dev(div1, "class", "content svelte-nrlo7l");
    			add_location(div1, file$3, 78, 4, 1262);
    			attr_dev(footer, "class", "svelte-nrlo7l");
    			add_location(footer, file$3, 81, 4, 1326);
    			attr_dev(article, "class", "svelte-nrlo7l");
    			add_location(article, file$3, 69, 0, 1069);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$2, 21, 0, 339);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 49, 4, 838);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$1, 46, 4, 759);
    			attr_dev(div, "class", "form-control svelte-1i5mnz");
    			add_location(div, file$1, 45, 0, 728);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$1, 43, 4, 661);
    			attr_dev(div, "class", "form-control svelte-1i5mnz");
    			add_location(div, file$1, 42, 0, 630);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file, 64, 4, 1860);
    			attr_dev(main, "class", "svelte-1k5t77g");
    			add_location(main, file, 63, 0, 1849);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    	...
    	let meetups = [
    		{
    			...
    			address: "27th Nerd Road, 35235 New York",
